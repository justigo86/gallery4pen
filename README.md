A create-react-app image gallery project that started as a means to implement Firebase Firestore while allowing the user to add/delete items from database.
